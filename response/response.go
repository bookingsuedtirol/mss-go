...
type SEOText struct {
	...
	DescriptionDeu NormalizedHTMLString `xml:"description_deu"`
	...
	DescriptionIta NormalizedHTMLString `xml:"description_ita"`
	...
	DescriptionEng NormalizedHTMLString `xml:"description_eng"`
	...
	DescriptionSpa NormalizedHTMLString `xml:"description_spa"`
	...
	DescriptionFra NormalizedHTMLString `xml:"description_fra"`
	...
	DescriptionRus NormalizedHTMLString `xml:"description_rus"`
	...
	DescriptionDan NormalizedHTMLString `xml:"description_dan"`
